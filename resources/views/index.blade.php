    ...
    <div class="site-section">
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-4">
            <img src="{{asset('reprint/images/about_1.jpg')}}" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-4">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-4">
            <div class="item web">
              <a href="work-single.html" class="item-wrap" data-fancybox="gal">
                ...
                <img class="img-fluid" src="{{asset('reprint/images/img_1.jpg')}}">
              </a>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            <div class="item web">
              <a href="work-single.html" class="item-wrap" data-fancybox="gal">
                <span class="icon-add"></span>
                <img class="img-fluid" src="{{asset('reprint/images/img_2.jpg')}}">
              </a>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            <div class="item web">
              <a href="work-single.html" class="item-wrap" data-fancybox="gal">
                <span class="icon-add"></span>
                <img class="img-fluid" src="{{asset('reprint/images/img_3.jpg')}}">
              </a>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            <div class="item web">
              <a href="work-single.html" class="item-wrap" data-fancybox="gal">
                <span class="icon-add"></span>
                <img class="img-fluid" src="{{asset('reprint/images/img_4.jpg')}}">
              </a>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            <div class="item web">
              <a href="work-single.html" class="item-wrap" data-fancybox="gal">
                <span class="icon-add"></span>
                <img class="img-fluid" src="{{asset('reprint/images/img_5.jpg')}}">
              </a>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            <div class="item web">
              <a href="work-single.html" class="item-wrap" data-fancybox="gal">
                <span class="icon-add"></span>
                <img class="img-fluid" src="{{asset('reprint/images/img_6.jpg')}}">
              </a>
            </div>
          </div>
        ...
        <div class="row justify-content-center">
          <div class="col-md-8">
            ...
            <a href="https://vimeo.com/191947042" data-fancybox  class="btn-video_38929">
              ...
              <img src="{{asset('reprint/images/img_1.jpg')}}" alt="Image" class="img-fluid">
            </a>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6">
            ...
            <div>
              <div class="person-pic-39219 mb-4">
                <img src="{{asset('reprint/images/person_1.jpg')}}" alt="Image" class="img-fluid">
              </div>  
          ...
          <div class="col-lg-4 col-md-6">
            ...
            <div>
              <div class="person-pic-39219 mb-4">
                <img src="{{asset('reprint/images/person_2.jpg')}}" alt="Image" class="img-fluid">
              </div>  
              <blockquote class="quote_39823">
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptas excepturi accusantium non aut perspiciatis nisi magni libero, molestias.</p>
              </blockquote>
          ...
          <div class="col-lg-4 col-md-6">
            ...
            <div>
              <div class="person-pic-39219 mb-4">
                <img src="{{asset('reprint/images/person_3.jpg')}}" alt="Image" class="img-fluid">
              </div>  
              <blockquote class="quote_39823">
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptas excepturi accusantium non aut perspiciatis nisi magni libero, molestias.</p>
              </blockquote>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="post-entry-1 h-100">
              <a href="single.html">
                <img src="{{asset('reprint/images/img_1.jpg')}}" alt="Image"
                 class="img-fluid">
              </a>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="post-entry-1 h-100">
              <a href="single.html">
                <img src="{{asset('reprint/images/img_2.jpg')}}" alt="Image"
                 class="img-fluid">
              </a>
              <div class="post-entry-1-contents">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="post-entry-1 h-100">
              <a href="single.html">
                <img src="{{asset('reprint/images/img_3.jpg')}}" alt="Image"
                 class="img-fluid">
              </a>
              <div class="post-entry-1-contents">
