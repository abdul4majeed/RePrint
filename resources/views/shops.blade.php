          ...
          <div class="col-lg-12 mb-5" >
            ...
            <div class="card d-inline-block" style="width: 18rem;">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">{{$shop->shop_city}}-{{$shop->shop_phone}}-{{$shop->shop_address}}</p>
                  <form action="{{route('get_shop_services')}}" method="post" class="d-inline-block">
                      {{csrf_field()}}
                      <input type="hidden" name="shop_id" value="{{$shop->id}}">
                      <input type="hidden" id="shop_name" disabled value="{{$shop->shop_name}}">
                      <input type="hidden" id="shop_owner_name" disabled value="{{$shop->shop_owner_name}}">
                      <input type="hidden" id="shop_phone" disabled value="{{$shop->shop_phone}}">
                      <input type="hidden" id="shop_email" disabled value="{{$shop->shop_email}}">
                      <input type="hidden" id="shop_address" disabled value="{{$shop->shop_address}}">
                      <input type="hidden" id="shop_city" disabled value="{{$shop->shop_city}}">
