      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 mb-5" >
            <form action="<?php echo e(route('loginProcess')); ?>" method="post" autocomplete="off">
...
<?php if($errors->has('loginerror')): ?>
                      ...
                      <?php if($errors->has('emailalreadyverify')): ?>
                      <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <script>
                      ...
                      <?php if($errors->has('accountnofound')): ?>
                      <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <script>
                      ...
                      <?php if($errors->has('please_verify')): ?>
                      <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\RePrint\RePrint\resources\views/login.blade.php ENDPATH**/ ?>